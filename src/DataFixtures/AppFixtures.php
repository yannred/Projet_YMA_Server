...
class AppFixtures extends Fixture
{
    ...
    'Pizza',
        ...
        array_push($tabProduit,
            ...
            array('CHEESE', 'Pain brioche, Steak 45g pure boeuf cuit au barbecue, cheddar, cornichons, ketchup, moutarde.', 4.9, self::PHOTO, false, 'Burger'),
            array('FLY FISH', 'Pain au sésame, poisson pané, cheddar, salade, tomates, oignons, sauce fish.', 4.9, self::PHOTO, false, 'Burger'),
            array('CHICKEN', 'Pain au sésame, poulet pané, cheddar, salade, tomates, oignons, sauce tartare.', 5.9, self::PHOTO, false, 'Burger'),
            array('TAHITIEN BURGER', 'Pain au sésame, steak 100g pure boeuf cuit au barbecue, tranche d\'ananas, salade, tomates, oignons sauce barbecue.', 5.9, self::PHOTO, false, 'Burger'),
            array('SEGUIN', 'Steak 100g, tomates, rondelles de chèvre.', 5.9, self::PHOTO, false, 'Burger'),
            array('BRAZIL', 'Pain au sésame, steak 100g pure boeuf cuit au barbecue, tranche de jambon, cheddar, salade, tomates, oignons.', 5.9, self::PHOTO, false, 'Burger'),
            array('GREC', 'Pain au sésame, steak 100g pure boeuf et émincés kebab cuit au barbecue , salade, tomates, oignons.', 6.1, self::PHOTO, true, 'Burger'),
            array('MYSTIC', 'Pain fariné cuit à la pierre, steak 180g pure boeuf cuit au barbecue, chekchouka (légumes grille au four légèrement épicée ) salade, sauce gruyère maison.', 5.9, self::PHOTO, true, 'Burger'),
            array('SAVOYARD', 'pain fariné cuit a la pierre Steak 180g pure boeuf cuit au barbecue ,sauce gruyère maison ,salade ,tomate ,oignons rouges ,tranche de jambon, oeuf ,fromage raclette.', 6.9, self::PHOTO, false, 'Burger'),
            array('BUFFALO', 'Steak 45g pure boeuf et escalope de poulet mariné cuit au barbecue, sauce buffalo, salade, tomates, oignons, cornichons, double cheddar.', 6.9, self::PHOTO, false, 'Burger'),
