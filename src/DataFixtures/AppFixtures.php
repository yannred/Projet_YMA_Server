...
class AppFixtures extends Fixture
{
    ...
    'Pizza',
        ...
        array_push($tabProduit,
            ...
            array('REGINA', 'Sauce tomate ou Crème fraîche, mozzarella, jambon, champignons frais.', 9.9, "/Produits/0010.png", true, 'Pizza'),
            array('TONNATA', 'Sauce tomate ou Crème fraîche, mozzarella, thon, olives.', 9.9, "/Produits/0011.png", true, 'Pizza'),
            array('ORIENTALE', 'Sauce tomate cuisiner maison ou Crème fraîche, mozzarella, merguez fraiche preparer maison et precuite a la braise, poivrons, oignons rouges.', 9.9, "/Produits/0012.png", false, 'Pizza'),
            array('CAMPIONE', 'Sauce tomate cuisiner maison ou Crème fraîche, mozzarella, viande hachée cuite a la braise ,olives vertes oeuf.', 9.9, "/Produits/0013.png", false, 'Pizza'),
            array('BUFFALO', 'Sauce tomate cuisiner maison ou Crème fraîche, mozzarella, viande hachée cuite a la braise, oignons rouges, olives.', 9.9, "/Produits/0014.png", false, 'Pizza'),
            array('MEDITERRANEENNE', 'Sauce tomate cuisiner maison ou Crème fraîche, mozzarella, fruits de mer, beurre persillé.', 9.9, "/Produits/0015.png", false, 'Pizza'),
            array('4 FROMAGES', 'Sauce tomate ou Crème fraîche, mozzarella, emmental, chèvre, roquefort.', 9.9, "/Produits/0016.png", false, 'Pizza'),
            array('CHEF', 'Sauce tomate ou Crème fraîche, mozzarella, viande hachée et merguez, poivrons et oignons rouges frais.', 9.9, "/Produits/0017.png", true, 'Pizza'),
            array('ALL STAR', 'Sauce tomate cuisinée maison ou Crème fraîche, mozzarella, poulet fumé en charcuterie, oignons rouges, poivrons frais, oeuf.', 11.9, "/Produits/0018.png", false, 'Pizza'),
            ...
            array('FLY FISH', 'Pain au sésame, poisson pané, cheddar, salade, tomates, oignons, sauce fish.', 4.9, "/Produits/0020.png", false, 'Burger'),
            array('CHICKEN', 'Pain au sésame, poulet pané, cheddar, salade, tomates, oignons, sauce tartare.', 5.9, "/Produits/0021.png", false, 'Burger'),
            array('TAHITIEN BURGER', 'Pain au sésame, steak 100g pure boeuf cuit au barbecue, tranche d\'ananas, salade, tomates, oignons sauce barbecue.', 5.9, "/Produits/0022.png", false, 'Burger'),
            array('SEGUIN', 'Steak 100g, tomates, rondelles de chèvre.', 5.9, "/Produits/0023.png", false, 'Burger'),
            array('BRAZIL', 'Pain au sésame, steak 100g pure boeuf cuit au barbecue, tranche de jambon, cheddar, salade, tomates, oignons.', 5.9, "/Produits/0024.png", false, 'Burger'),
            array('GREC', 'Pain au sésame, steak 100g pure boeuf et émincés kebab cuit au barbecue , salade, tomates, oignons.', 6.1, "/Produits/0025.png", true, 'Burger'),
            array('MYSTIC', 'Pain fariné cuit à la pierre, steak 180g pure boeuf cuit au barbecue, chekchouka (légumes grille au four légèrement épicée ) salade, sauce gruyère maison.', 5.9, "/Produits/0026.png", true, 'Burger'),
